...
public class JosephService {
	private static final String POSITIVE_NUMBER_REGEX = "^\\d+$";
	Logger logger = Logger.getLogger(JosephService.class);
	 ...
	 */
	public String josephFunction(List<String> list, String start, String interval) throws IllegalArgumentException {
